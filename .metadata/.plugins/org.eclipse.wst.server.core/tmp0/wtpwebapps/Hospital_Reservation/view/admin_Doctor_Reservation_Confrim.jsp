       ...
       <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-12 text-center">
              <button class="btn btn-primary" type="button" onclick="javascript:submitForm(this.form,'admin_Doctor_Reservation_Update.jsp')">수정<i class="fa fa-check spaceLeft"></i></button>
