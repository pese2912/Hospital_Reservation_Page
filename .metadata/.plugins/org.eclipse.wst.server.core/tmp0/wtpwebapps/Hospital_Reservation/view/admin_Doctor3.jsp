...
function reservation_confirm(id,date,email,subject){
    ...
    window.open('admin_Doctor_Reservation_Confrim.jsp?doc_id='+'Doctor3'+'&id='+id+'&date='+date+'&email='+email+'&subject='+subject+'',"의사예약내역확인","width=800,height=500");
			//값을 넘겨준다.
  //  window.open('rsv_Login.jsp?ydate='+ydate+'&doctor='+doctor+'&subject='+subject+'',"예약정보","width=600,height=500");
	...
	<tr>
		<td>
			...
			<ul class="nav nav-tabs"style="font-size:15px;">
  			...
  			<li role="presentation"  class="active"><a href="admin_Doctor3.jsp">Doctor3</a></li>
