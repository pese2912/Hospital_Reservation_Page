...
<%
	...
	List<Reservation> rvs = manager.getDoctorReservation("Doctor8");
	ScheduleDao scheduleManager = ScheduleDao.getInstance();
	List<Schedule> schedule = scheduleManager.getSchedule("Doctor8");
	...
	<tr>
		<td>
			...
			<ul class="nav nav-tabs"style="font-size:15px;">
  			...
  			<li role="presentation"class="active"><a href="admin_Doctor8.jsp">Doctor8</a></li>
