      ...
      name="myform">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-6">
            <input class="form-control" id="subject" name="subject"  type="text"   value = "<%=subject %>">
          </div>
        </div>
        
      
         <input class="form-control" id="old_id" name="old_id" type="hidden" readonly="readonly" value ="<%=id %>" >    
