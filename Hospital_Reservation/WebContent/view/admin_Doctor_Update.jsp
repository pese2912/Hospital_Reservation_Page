      ...
      name="myform">
            ...
            <label class="col-sm-3 control-label" for="inputName">예약날짜</label>
              <div class="col-sm-6">
                <div class="input-group">
                  <div class="tit"><input type="text" class='datetimepicker' name="date" id="date" value="<%=date %>"> </div>           
                </div>
             </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label" for="inputPassword">일정</label>
        	<div class="col-sm-6">
          <input class="form-control" id="todo" name="todo" type="text"  value ="<%=todo %>" >     
        	</div>
        </div>
        ...
        <input class="form-control"  id="old_date" name="old_date" type="hidden" readonly="readonly"  value ="<%=date %>" >   
        
        <div class="form-group">
          <div class="col-sm-12 text-center">
         

            <button class="btn btn-primary" type="button" onclick="javascript:submitForm(this.form,'admin_Doctor_UpdatePro.jsp')">수정하기<i class="fa fa-check spaceLeft"></i></button>
